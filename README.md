...
para o envio de e-mails. Por fim, a interface do site conta com uma autenticação simples (ainda será melhorada) e um calendário com caixas de resposta em ambos os lados.
