...
para o envio de e-mails. Desse modo, a interface do site conta com uma autenticação simples utilizando o Supabase para aumentar a segurança de dados, sem que as informações
confidenciais passem pelo N8N, impossibilitando vazamento de dados.
